...
# Hugging Face hub/network controls for model initialization
EMBEDDING_HF_ETAG_TIMEOUT_SECONDS = 30
EMBEDDING_HF_DOWNLOAD_TIMEOUT_SECONDS = 120
EMBEDDING_LOCAL_FILES_ONLY = False
EMBEDDING_ENABLE_LOCAL_FALLBACK = True
...
# When True, show the generated answer even if quality gates trigger refusal.
ENABLE_SHOW_FLAGGED_ANSWERS = True
